...
const data = [
  ...
  },
  {
    table: 'club',
    rows: [
        { id:  1, sport_id: 1, country_id: 1, name: 'SDZ',                  city: 'Amsterdam' },
        { id:  2, sport_id: 1, country_id: 1, name: 'Ilpendam',             city: 'Ilpendam'  },
        { id:  3, sport_id: 1, country_id: 1, name: 'Purmerend FC',         city: 'Purmerend' },
        { id:  4, sport_id: 1, country_id: 1, name: 'IVV',                  city: 'Landsmeer' },
        { id:  5, sport_id: 1, country_id: 1, name: 'Nieuw-West United SV', city: 'Amsterdam' },
        { id:  6, sport_id: 1, country_id: 1, name: 'Zaandijk',             city: 'Zaandijk'  },
        { id:  7, sport_id: 1, country_id: 1, name: 'Swift',                city: 'Amsterdam' },
        { id:  8, sport_id: 1, country_id: 1, name: 'Germaan/De Eland ASC', city: 'Amsterdam' },
        { id:  9, sport_id: 1, country_id: 1, name: 'Wherevogels De',       city: 'Purmerend' },
        { id: 10, sport_id: 1, country_id: 1, name: 'Buitenveldert SC',     city: 'Amsterdam' },
        { id: 11, sport_id: 1, country_id: 1, name: 'RCZ',                  city: 'Zaandam'   },
        { id: 12, sport_id: 1, country_id: 1, name: 'Meteoor De',           city: 'Amsterdam' },
        { id: 13, sport_id: 1, country_id: 1, name: 'dvc Buiksloot',        city: 'Amsterdam' },
        { id: 14, sport_id: 1, country_id: 1, name: 'DRC',                  city: 'Amsterdam' },
    ]
  },
  {
    table: 'season',
